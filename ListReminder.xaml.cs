...
{
    public partial class ListReminder : PhoneApplicationPage
    {
        ...
        private void ApplicationBarAddButton_Click(object sender, EventArgs e)
        {
            ...
            NavigationService.Navigate(new Uri("/Sva-Chikitsa/Alarms/AddReminder.xaml", UriKind.RelativeOrAbsolute));
        }
    }
}